...
namespace MyLibrarySystem {
    ...
    public partial class MyLibraryDataSet1 : global::System.Data.DataSet {
        ...
        public partial class BookDataTable : global::System.Data.TypedTableBase<BookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BookRow AddBookRow(string Language, int price, string Title) {
...
namespace MyLibrarySystem.MyLibraryDataSet1TableAdapters {
    ...
    public partial class AuthorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Author_name FROM dbo.Author";
    ...
    public partial class BookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Book] WHERE (([Book_ID] = @Original_Book_ID) AND ((@IsNull_Language = 1 AND [Language] IS NULL) OR ([Language] = @Original_Language)) AND ([price] = @Original_price) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Book] SET [Language] = @Language, [price] = @price, [Title] = @Title WHERE (([Book_ID] = @Original_Book_ID) AND ((@IsNull_Language = 1 AND [Language] IS NULL) OR ([Language] = @Original_Language)) AND ([price] = @Original_price) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)));
SELECT Book_ID, Language, price, Title FROM Book WHERE (Book_ID = @Book_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Book_ID, Language, price, Title FROM dbo.Book";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Delete(int Original_Book_ID, string Original_Language, int Original_price, string Original_Title) {
        ...
        public virtual int Update(string Language, int price, string Title, int Original_Book_ID, string Original_Language, int Original_price, string Original_Title, int Book_ID) {
            if ((Language == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Language, int price, string Title, int Original_Book_ID, string Original_Language, int Original_price, string Original_Title) {
            return this.Update(Language, price, Title, Original_Book_ID, Original_Language, Original_price, Original_Title, Original_Book_ID);
        }
    }
